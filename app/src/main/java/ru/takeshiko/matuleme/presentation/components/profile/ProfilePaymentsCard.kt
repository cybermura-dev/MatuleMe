...
fun ProfilePaymentsCard(
    ...
    val defaultPayment = payments.find { it.isDefault }
    ...
    Card(
        ...
        Row(
            ...
            Icon(
                ...
                contentDescription = stringResource(R.string.profile_payments_title),
            ...
            Column(modifier = Modifier.weight(1f)) {
                Text(
                    text = stringResource(R.string.profile_payments_title),
                    ...
                    Column(
                        ...
                        if (isLoading) {
                            ...
                            val countText = if (count > 0) {
                                pluralStringResource(R.plurals.profile_payments_count, count, count)
                            } else {
                                stringResource(R.string.profile_no_payments)
                            }
                            ...
                            defaultPayment?.cardNumber?.let { cardNumber ->
                                if (cardNumber.length >= 4) {
                                    ...
                                    Text(
                                        text = stringResource(
                                            R.string.profile_payment_primary_card,
                                            lastFour
                                        ),
                                        style = typography.bodySmall,
                                        color = appColors.textSecondary,
